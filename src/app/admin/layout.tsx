      ...
      <div className="sm:hidden fixed bottom-3 inset-x-3 z-40 pointer-events-none no-print">
        ...
        >
          ...
          <button
            ...
            className={`relative flex flex-col items-center justify-center flex-1 py-1 px-1 rounded-full transition-all min-h-[46px] cursor-pointer ${
          ...
          >
            <div
              className={`p-1.5 rounded-full transition-all ${
                isMoreActive || moreMenuOpen ? 'bg-emerald-700 text-white shadow-xs shadow-emerald-700/30 scale-105' : 'text-slate-500 hover:bg-slate-100'
              }`}
            >
              {moreMenuOpen ? (
